...
The current code is intended for 2 LEDs instead of 12. To adjust the code for 12 LEDS (or your desired number) simply copy paste lines 78-90 (both inclusive) for each additional LED you would like. Adjust the number on line 78 to be the pin number for your additional LED(s). Also adjust variable "reading" on line 80 to be reading3 if 3rd LED, reading4 if 4th LED, reading5 if 5th LED, etc.
